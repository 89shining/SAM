...
from testdataset_random import TestDataset
import shutil
...
model_type = "vit_b"
csv_path = "/home/wusi/SAMdata/20250711_GTVp/test/test_rgb.csv"   # 测试数据CSV文件路径
root_dir = "/home/wusi/SAMdata/20250711_GTVp/test"                         # 测试集根目录
image_dir = "/home/wusi/SAMdata/20250711_GTVp/test/rgb_images"             # 测试image
ii_dir = "/home/wusi/SAMdata/20250711_GTVp/test_nii"                      # 对应的参考NIfTI图像路径（含image.nii.gz）
base_output_dir = "/home/wusi/SAMdata/20250711_GTVp/TestResults/Pos_box_prompts/random" # 预测输出结果根目录
expand_cm_list = [0.5]  # 外扩距离（单位：cm）
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

for expand_cm in expand_cm_list:
    print(f"\n=== 正在处理外扩距离: {expand_cm} cm ===")
    output_dir = os.path.join(base_output_dir, f"expand_{expand_cm:.1f}cm_vis")
