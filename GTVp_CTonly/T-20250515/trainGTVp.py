...
if __name__ == '__main__':
    root_dir = 'C:/Users/dell/Desktop/SAM/GTVp_CTonly/20250515/Dataset/train'  # traindataset的目录
    ...
    save_dir = 'C:/Users/dell/Desktop/SAM/GTVp_CTonly/20250515/trainresults_kfold'    # 训练结果保存文件夹
    ...
    dataset = SAMDataset(csv_path=csv_path, root_dir=root_dir, nii_dir = nii_dir, target_size=(1024, 1024), num_pos=0, num_neg=0)
