...
# tensorboard训练日志保存目录：./runs/finetune1
writer=SummaryWriter('./runs/finetune1')
...
if __name__ == '__main__':
    # 配置日志保存
    saveDir = "C:/Users/dell/Desktop/SAM/Train/Dataset/results"
    ...
    val_percent = 0.2
    save_cp = True
    trainDir = 'C:/Users/dell/Desktop/SAM/Train/Dataset'
    trainFile = 'C:/Users/dell/Desktop/SAM/Train/Dataset/train_tiff.csv'
    BatchSize = 1
    nEpochs = 5
    flr = 0.001
