...
from GTVp_CTonly.T_20250515.dice_loss import dice_loss
...
# 加载预训练权重
net.load_state_dict(torch.load("C:/Users/dell/Desktop/SAM/GTVp_CTonly/20250515/trainresults_kfold/fold_2/weights/best.pth", map_location='cuda'))
net.eval()
net.to(device)
...
test_dir = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/20250515/testresults/fold_2"     # 测试结果保存主目录
save_dir = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/20250515/testresults/fold_2/masks_pred"     # 预测mask保存目录
dice_csv_path ="C:/Users/dell/Desktop/SAM/GTVp_CTonly/20250515/testresults/fold_2/dice.csv"
