"""
最终版：5折融合 + 原始Excel写法(overview+每个病人sheet)
+ 缓存image_embeddings加速 + 保留2位小数
+ 用3D HD95(mm) 替代 Dice
"""
...
base_output_dir = "/home/wusi/SAMdata/20250821/testresults/hd95"
    ...
    with pd.ExcelWriter(xlsx_path, engine="openpyxl") as writer:
        ...
        if df_all:
            ...
            overview = (df_all.groupby("r", as_index=False)
                        .agg(hd95_mm=("hd95_mm", "mean"),
                             dL_mean_mm=("dL_mean_mm", "mean"),
                             dR_mean_mm=("dR_mean_mm", "mean"),
                             dT_mean_mm=("dT_mean_mm", "mean"),
                             dB_mean_mm=("dB_mean_mm", "mean"),
                             n_patients=("patient_id", "nunique")))
            overview[["hd95_mm","dL_mean_mm","dR_mean_mm","dT_mean_mm","dB_mean_mm"]] = \
                overview[["hd95_mm","dL_mean_mm","dR_mean_mm","dT_mean_mm","dB_mean_mm"]].round(2)
        ...
        for pa, rows in sorted(patient_rows.items(), key=lambda x: x[0]):
            ...
            df[["hd95_mm","dL_mean_mm","dR_mean_mm","dT_mean_mm","dB_mean_mm"]] = \
                df[["hd95_mm","dL_mean_mm","dR_mean_mm","dT_mean_mm","dB_mean_mm"]].round(2)
