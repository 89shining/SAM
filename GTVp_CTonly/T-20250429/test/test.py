...
from GTVp_CTonly.T_20250429.dice_loss import dice_loss
...
# 加载预训练权重
net.load_state_dict(torch.load("C:/Users/dell/Desktop/SAM/GTVp_CTonly/trainresults/finetune2.1/weights/best.pth", map_location='cuda'))
net.eval()
net.to(device)

csv_path = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/Dataset/test/train_tiff.csv"
root_dir = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/Dataset/test"
image_dir = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/Dataset/test/images"
test_dir = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/testresults/finetune2.1"     # 测试结果保存主目录
save_dir = "C:/Users/dell/Desktop/SAM/GTVp_CTonly/testresults/finetune2.1/masks_pred"     # 预测mask保存目录
dice_csv_path ="C:/Users/dell/Desktop/SAM/GTVp_CTonly/testresults/finetune2.1/dice.csv"
