...
# ========= 配置路径（请根据实际路径修改） =========
fold_ckpts = [
    "/home/wusi/SAMdata/Rectal/20260310_CTV/dataset/trainresult_3slices/freeze_img/fold_1/weights/best.pth",                      # 每个fold的best权重路径
...
base_output_dir = "/home/wusi/SAMdata/Rectal/20260310_CTV/dataset/testresults_3slices/freeze_img" # 预测输出结果根目录
