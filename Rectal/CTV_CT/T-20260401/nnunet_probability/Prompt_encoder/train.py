...
def _forward_masks_batched(net, imgs, mask_inputs, freeze_image_encoder=True):
    ...
    try:
        ...
        # Some environments hit cuDNN frontend plan-selection failure:
        # "... was unable to find an engine to execute this computation".
        # Retry once with cuDNN disabled for this forward.
...
if __name__ == '__main__':
    ...
    save_dir = '/home/wusi/segment-anything/SAMdata/Rectal/20260401_CTV/nnunet_probability/Prompt_encoder/TrainResult'
    ...
    if device.type == "cuda":
        ...
        print(f"[CUDA] logical_device_count={torch.cuda.device_count()}, current_device={torch.cuda.current_device()}, name={torch.cuda.get_device_name(torch.cuda.current_device())}")
