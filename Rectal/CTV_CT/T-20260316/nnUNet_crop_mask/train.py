    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=len(train_loader), desc=f'[Train Fold {fold + 1}]', unit='batch', disable=True) as pbar:
            ...
            for batch_idx, batch in enumerate(train_loader):
                ...
                mask_inputs = batch['mask_prompt'].to(device)
...
if __name__ == '__main__':
    nii_root_dir = "/home/wusi/segment-anything/SAMdata/Rectal/20260316_CTV/Cropdatanii/train_nii"
    save_dir = '/home/wusi/segment-anything/SAMdata/Rectal/20260316_CTV/nnUNet_crop_mask/TrainResult'
    ...
    dataset = SAMDatasetFromNiiGz(
        ...
        gt_name="CTV.nii.gz",
        nnunet_name="prompt.nii.gz"  # 改成真实名字
    )
