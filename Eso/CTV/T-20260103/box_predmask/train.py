...
def train_one_fold(fold, train_idx, val_idx, all_image_paths, dataset, net, device,
    ...
    train_ids = [os.path.splitext(os.path.basename(all_image_paths[i]))[0]
                 for i in train_idx]
    val_ids = [os.path.splitext(os.path.basename(all_image_paths[i]))[0]
               for i in val_idx]
        ...
        with tqdm(total=len(train_loader), desc=f'[Train Fold {fold + 1}]', unit='batch', disable=True) as pbar:
            ...
            for batch_idx, batch in enumerate(train_loader):
                ...
                for i in range(len(imgs)):
                    sparse_embeddings_1, dense_embeddings_1 = net.prompt_encoder(
                        points=None,
                    ...
                    logits_list.append(low_res_masks_2)
...
if __name__ == '__main__':
    root_dir = '/home/wusi/SAMdata/Eso/20251217_CTV/dataset/train'  # traindataset的目录
    csv_path = '/home/wusi/SAMdata/Eso/20251217_CTV/dataset/train/train_rgb.csv'
    nii_dir = "/home/wusi/SAMdata/Eso/20251217_CTV/datanii/train_nii"  # trainnii数据文件夹
    save_dir = '/home/wusi/SAMdata/Eso/20260104_CTV/box_predmask/TrainResult'  # 训练结果保存文件夹
