...
from testdatasetCTV_num import TestDataset
import shutil
...
root_dir = "/home/wusi/SAMdata/Eso-CTV/20251217/dataset/test"              # 测试集根目录
image_dir = "/home/wusi/SAMdata/Eso-CTV/20251217/dataset/test/rgb_images"   # 测试image
ii_dir = "/home/wusi/SAMdata/Eso-CTV/20251217/datanii/test_nii"          # 对应的参考NIfTI图像路径（含image.nii.gz）           # 对应的参考NIfTI图像路径（含image.nii.gz）
base_output_dir = "/home/wusi/SAMdata/Eso-CTV/20251217/Num_box_prompts" # 预测输出结果根目录
