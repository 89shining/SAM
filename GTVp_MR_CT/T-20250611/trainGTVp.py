    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=len(train_loader), desc=f'[Train Fold {fold + 1}]', unit='batch', disable=True) as pbar:
            ...
            for batch_idx, batch in enumerate(train_loader):
                ...
                use_mask_prompt = batch['use_mask_prompt']
...
if __name__ == '__main__':
    root_dir = '/home/intern/wusi/Dataset/GTVp_MRI0611/dataset/'  # traindataset的目录
    csv_path = '/home/intern/wusi/Dataset/GTVp_MRI0611/dataset/rgb_dataset.csv'
    nii_dir = "/home/intern/wusi/Dataset/GTVp_MRI0611/datanii"  # trainnii数据文件夹
    save_dir = '/home/intern/wusi/Dataset/GTVp_MRI0611/trainresults_kfold'  # 训练结果保存文件夹
